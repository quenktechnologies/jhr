 ...
 */
exports.createAgent = function (host) { return new agent_1.Agent(host, {}, new memory_1.MemoryContainer(), { ttl: 0, tags: [], context: {} }, new json_1.JSONTransform(), new xhr_1.XHRTransport('', new json_2.JSONParser()), []); };
/**
...
exports.get = function (url, params, headers) {
    ...
    var _a = splitUrl(url), host = _a[0], path = _a[1];
