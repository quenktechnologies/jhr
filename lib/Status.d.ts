...
export declare const NON_AUTHORITATIV_INFO = 203;
...
export declare const PROXY_AUTH_REQUIRED = 407;
...
export declare const REQUEST_ENTITY_TOO_LARGE = 413;
...
export declare const UNAVAILABLE_FOR_LEGAL_RREASONS = 451;
