...
var Request = (function () {
    ...
    Request.prototype.execute = function () {
        ...
        var _a = this.method, method = _a.method, params = _a.params, _b = _a.options, _c = _b.headers, headers = _c === void 0 ? {} : _c, _d = _b.ttl, ttl = _d === void 0 ? 0 : _d, _e = _b.context, context = _e === void 0 ? {} : _e;
        var _f = this, url = _f.url, agent = _f.agent;
        var read = (method.toUpperCase() === Methods.GET) ||
            (method.toUpperCase() === Methods.HEAD);
        return new Promise(function (resolve, reject) {
            var payload = read ? null : params ? agent.transform.parseRequestBody(params) : null;
            xhr.open(method, Utils.urlFromString(polate_1.polate(url, context), read ? params : null), true);
            xhr.onload = function () {
                return resolve(Response.create(xhr, agent.transform.parseResponseBody(xhr.response), _this.method.options));
            };
            if (ttl > 0)
                xhr.timeout = ttl;
